...
if sol_plots==True:
    ...
    for dt in [0.0005, 0.005, 0.05, 0.5]:
        ...
        ax.set_title(f"Exact Solution vs Approximate Solution for X1, dt={dt}", fontsize=title_size)
        ...
        ax.tick_params(axis='both', which='major', labelsize=tick_size)    
        ax.set_title(f"Exact Solution vs Approximate Solution for X2, dt={dt}", fontsize=title_size)
        ax.legend(fontsize=legend_size)
        ax.grid()
        ax.set_aspect(ar)
